...
const PROFILE_DEFINITIONS: ProfileDefinition[] = [
  ...
  },
  {
    ...
    category: 'General',
    description: 'Use SafeTrace default safety checks and query-based evidence ranking.',
    defaultQuery: 'general safety violations',
    backendSupportLevel: 'partial',
    supportedChecks: ['query relevance', 'visible rule-based safety findings', 'rule-based fallback evidence'],
    ...
    limitations: 'General review is broad; specific profiles provide clearer query intent and result interpretation.',
    conflictTerms: [],
  },
  {
